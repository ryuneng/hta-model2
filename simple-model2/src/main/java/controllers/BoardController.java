...
public class BoardController {
	...
	public String form(HttpServletRequest req, HttpServletResponse resp) throws Exception {
		return "board/form.jsp";   // GET 내부이동
	}
	...
	public String save(HttpServletRequest req, HttpServletResponse resp) throws Exception {
		...
		return "redirect:list.do?page=1"; // POST 재요청
	}
	...
	public String list(HttpServletRequest req, HttpServletResponse resp) throws Exception {
		...
		req.setAttribute("boardList", dto.getItems());   // List<Board> 객체
		req.setAttribute("paging", dto.getPagination()); // Paigination 객체 
